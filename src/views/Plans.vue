...
<script setup>
const plans = [
  { id: 'free', title: 'Free', price: '$0', devices: '01 device', note: 'A complete sensing device.', features: ['Occupancy detection and predictions', 'Live sensor visualization', 'Home Assistant integration', 'View captured data (400-minute history)'] },
  { id: 'home', title: 'Home', price: '$5', devices: '05 devices', featured: true, note: 'A connected set of smart rooms.', features: ['Everything in Free', 'Up to 5 devices', '10 GB cloud storage with auto sync', 'Download and export raw data'] },
  { id: 'research', title: 'Research', price: '$15', devices: '10 devices', note: 'The full research workflow.', features: ['Everything in Home', 'Up to 10 devices, 100 GB cloud storage', 'Research datasets and Python SDK', 'Research Labs with notebook grading'] },
]
