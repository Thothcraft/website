  ...
  >
    ...
    >
      ...
      <v-row>
        ...
        >
          <v-card
            class="scenario-card h-100 pa-5"
            elevation="0"
          >
            <v-icon
              :color="s.color"
    ...
    <div class="section-light py-12">
      <v-container style="max-width: 1100px;">
        ...
        <v-row>
          ...
          >
            <div
              class="sensor-icon-wrapper"
              :class="sensor.wrapperClass"
              @mouseenter="sensor.hover = true"
              ...
              >
                <g v-if="sensor.name === 'WiFi CSI'">
                  <circle
                    ...
                    r="28"
                    :fill="sensor.bgColor"
                    :opacity="sensor.hover ? 0.3 : 0.1"
                  />
                  <path
                    d="M32 48C25.3726 48 20 42.6274 20 36C20 29.3726 25.3726 24 32 24C38.6274 24 44 29.3726 44 36C44 42.6274 38.6274 48 32 48Z"
                    :fill="sensor.color"
                    :opacity="sensor.hover ? 1 : 0.7"
                  />
                  <path
                    d="M32 20C23.1634 20 16 27.1634 16 36C16 44.8366 23.1634 52 32 52C40.8366 52 48 44.8366 48 36C48 27.1634 40.8366 20 32 20Z"
                    :fill="sensor.color"
                    :opacity="sensor.hover ? 0.5 : 0.3"
                  />
                  <path
                    d="M32 16C21.5059 16 13 24.5059 13 35C13 45.4941 21.5059 54 32 54C42.4941 54 51 45.4941 51 35C51 24.5059 42.4941 16 32 16Z"
                    :fill="sensor.color"
                    :opacity="sensor.hover ? 0.3 : 0.15"
                  />
                  <circle
                    cx="32"
                    cy="36"
                ...
                <g v-else-if="sensor.name === 'Microphone'">
                  ...
                  />
                  <path
                    d="M18 32C18 25.3726 23.3726 20 30 20"
                    :stroke="sensor.color"
                    :stroke-width="2"
                    :opacity="sensor.hover ? 0.5 : 0.3"
                    fill="none"
                  />
                  <path
                    d="M46 32C46 25.3726 40.6274 20 34 20"
                    :stroke="sensor.color"
                    :stroke-width="2"
                    :opacity="sensor.hover ? 0.5 : 0.3"
                    fill="none"
    ...
    >
      <v-row align="center">
        ...
        >
          <v-card
            class="yaml-card pa-5"
            elevation="0"
          >
            <p class="yaml-label mb-2">
              Example Automation
            </p>
    ...
    >
      <v-row justify="center">
        ...
        >
          ...
          <h2 class="section-title mb-3">
            Presence You Can Place in the Room
          </h2>
      ...
      <v-row justify="center">
        ...
        >
          <v-card
            class="fl-point-card pa-5 h-100 text-center"
            elevation="0"
          >
            <v-icon
              :color="point.color"
            ...
            <h4 class="fl-point-title mb-2">
              {{ point.title }}
            </h4>
            <p class="fl-point-text">
              {{ point.text }}
            </p>
          </v-card>
        </v-col>
