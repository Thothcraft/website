<template>
  <div class="product-page">
    ...
    <section class="included">
      ...
      <p class="local-intro">The device does not require Portal access for everyday use on the same local network.</p>
    ...
    <section class="portal-plan">
      ...
      <div class="plan-card"><p class="price"><strong>$10</strong><span>USD / month</span></p><p>Portal brings the same device and data controls beyond your local network.</p><ul><li>Remote access to device functions</li><li>Remote access to collected data</li><li>Multi-device management</li></ul><a href="https://portal-three-rho.vercel.app/auth" target="_blank" rel="noopener">Start with Portal ↗</a></div>
    </section>
  </div>
</template>
